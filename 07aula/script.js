...
function mostraAlternativas() {
    for (const opcao of perguntaAtual.opcoes) {
        ...
        elementoOpcoes.textContent = opcao.texto; // add .texto para mostrar o texto das alternativas
        // adicionar ouvinte: reconhece o clique no botão e passa para a próxima questão
        elementoOpcoes.addEventListener("click", function () {
            atual++;
            mostraPerguntaAtual();
        });
        // problema para a próxima aula: as alternativas se acumulam 
