...
function mostraPerguntaAtual() {
    // adicionar momento para mostrar o resultado
...
function mostraResultado() {
    textoPergunta.textContent = "Essa é uma história de..."; // o que vai aparecer no texto da caixa de perguntas
    caixaAlternativas.textContent = ""; // esvaziar a caixa de alternativas
    resultadoTexto.textContent = historia; // mostrar a afirmação que criamos
}

mostraPerguntaAtual();

// problema para a próxima aula: esta aparecendo a última afirmação apenas, toques finais em css
